...
import com.technifysoft.olxkotlin.databinding.ActivityLoginOptionsBinding

class LoginOptionsActivity : AppCompatActivity() {

    //view binding or respective layout i.e. activity_login_options.xml
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //handle loginPhoneBtn click, open LoginPhoneActivity to login with Email & Password
    ...
    private val googleSignInARL = registerForActivityResult(
        ...
        if (result.resultCode == RESULT_OK){
            //User has chosen some option to login from intent, get data/intent from the result param to get logged in user info, we will use that to login with firebase auth
